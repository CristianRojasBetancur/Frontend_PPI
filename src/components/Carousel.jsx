                    ...
                    <Carousel.Item>
                        ...
                        <Carousel.Caption>
                            <div className="col-lg-12">
                                <img
                                    className="d-inline col-lg-6 m-4 imagen_carrusel" style={{ width: "200px", height: "150px", marginLeft:"auto", marginRight:"auto"}}
                    ...
                    <Carousel.Item>
                        ...
                        <Carousel.Caption>
                            ...
                            <div className="col-lg-12">
                                ...
                                <h4>$ 32.500</h4>
                                <p>Luce el escudo de nuestra institución con esta elegante camisa de diario.</p>
                            </div>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
